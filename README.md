...
[![Docker](https://github.com/htomer/cloudflare-ddns-updater/actions/workflows/docker-publish.yml/badge.svg?event=release)](https://github.com/htomer/cloudflare-ddns-updater/actions/workflows/docker-publish.yml)
![GitHub Release](https://img.shields.io/github/v/release/htomer/cloudflare-ddns-updater)
...
docker run \
  ...
  ghcr.io/htomer/cloudflare-ddns-updater
```
...
[MIT](https://github.com/htomer/cloudflare-ddns-updater/blob/main/LICENSE)